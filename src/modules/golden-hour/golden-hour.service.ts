...
// features/golden-hour/golden-hour.service.ts; only DI + Nest exceptions +
...
export class GoldenHourService {
  ...
  async seedDefaults(): Promise<void> {
    ...
    console.log(`Seeded ${DEFAULT_GOLDEN_HOURS.length} golden_hour_configs`);
  }
  ...
  async create(dto: CreateGoldenHourDto): Promise<GoldenHourResponseDto> {
    ...
    console.log('Created golden hour', {
  ...
  async update(
    ...
    console.log('Updated golden hour', { id });
